...
export default function Home() {
    const stats = [
        { value: "0", label: "Meals Shared" },
        { value: "0", label: "Active Donors" },
        { value: "0", label: "Partner NGOs" },
                ...
                <div className="max-w-6xl mx-auto px-6">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-blue-700 max-w-2xl mx-auto text-lg">
                            Hunger Bridge is a community-driven platform dedicated to connecting surplus food from donors to those in need. Our mission is to reduce food waste and fight hunger by making food sharing simple, safe, and impactful. Join us in building a bridge of compassion and support across our communities.
                        </p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-blue-100">
                            ...
                            <p className="text-blue-600">
                                To ensure that no surplus food goes to waste and every meal reaches someone in need.
                            </p>
                        </div>
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-blue-100">
                            <h3 className="text-xl font-semibold text-blue-800 mb-3">Our Vision</h3>
                            <p className="text-blue-600">
                                A world where communities unite to eliminate hunger and food waste through technology and collaboration.
                            </p>
                        </div>
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-blue-100">
                            <h3 className="text-xl font-semibold text-blue-800 mb-3">Get Involved</h3>
                            <p className="text-blue-600">
                                Whether you are a donor, NGO, or volunteer, your participation makes a real difference. Sign up today and be part of the solution!
                            </p>
                        </div>
                    </div>
                </div>
